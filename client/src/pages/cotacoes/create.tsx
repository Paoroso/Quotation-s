...
export default function CreateUser() {
  ...
  const handleProcess: SubmitHandler<CreateCotacaoFormData> = async (data) => {
    const { data: response } = await api.post<Cotacao & { user_id: number }>(
      "/cotacao/processamento",
      data
    );
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent bg="#1c1846">
          ...
          <ModalBody>
            ...
            Preço do produto: {cotacao &&
              numberFormatter(cotacao.productPrice)}{" "}
            <br />
            Quantidade de parcelas: {cotacao?.paymentType} <br />
